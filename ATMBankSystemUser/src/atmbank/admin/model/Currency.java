...
@NamedQueries({
    ...
    @NamedQuery(name = "Currency.getAllCurrencyName", query = "SELECT c.currencyName FROM Currency c"),
    @NamedQuery(name = "Currency.findByCurrencyID", query = "SELECT c FROM Currency c WHERE c.currencyID = :currencyID"),
    @NamedQuery(name = "Currency.getAllCurrencySymbol", query = "SELECT c.currencySymbol FROM Currency c"),
...
public class Currency implements Serializable {
    ...
    public String toString() {
        return "atmbank.admin.view.model.Currency[ currencyID=" + currencyID + " ]";
    }
